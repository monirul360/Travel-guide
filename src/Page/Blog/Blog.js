        ...
        <div>
            <section>
                <div className="ans-container">
                    <br /><br />
                    <h2 id='title'>1. Difference between authorization and authentication?</h2>
                    <h2>Authentication</h2>
                    <ul>
                        <li>In authentication process, the identity of users are checked for providing the access to the system.</li>
                        <li>In authentication process, users or persons are verified
                        </li>
                        <li>It is done before the authorization process.
                        </li>
                        <li>It needs usually users login details.
                        </li>
                    </ul>
                    <h2>Authorization</h2>
                    <ul>
                        <li>While in authorization process, persons or users authorities are checked for accessing the resources
                        </li>
                        <li>While in this process, users or persons are validated.
                        </li>
                        <li>While this process is done after the authentication process.
                        </li>
                        <li>While it needs users privilege or security levels.
                        </li>
                    </ul>
                </div>
                <div className="ans-container">
                    <h2 id='title'>2. Why are you using firebase? What other options do you have to implement authentication?</h2>
                ...
                <div className="ans-container">
                    <h2 id='title'>3. What other services does firebase provide other than authentication?
                    </h2>
